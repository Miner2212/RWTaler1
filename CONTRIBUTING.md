Contributing to RWTaler Core
============================

The RWTaler Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/rwtaler-project/rwtaler/blob/master/doc/translation_process.md)
...
The following applies to code changes to the RWTaler Core project, and is not to be
confused with overall RWTaler Network Protocol consensus changes.

Whether a pull request is merged into RWTaler Core rests with the project merge
...
Patches that change RWTaler consensus rules are considerably more involved than
...
Where a patchset proposes to change the RWTaler consensus, it must have been
...
The project leader is the release manager for each RWTaler Core release.
