...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "RWTaler server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* RWTaler features */
        {"rwtaler", "listmasternodes", &listmasternodes, true, true, false},
        {"rwtaler", "getmasternodecount", &getmasternodecount, true, true, false},
        {"rwtaler", "masternodeconnect", &masternodeconnect, true, true, false},
        {"rwtaler", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"rwtaler", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"rwtaler", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"rwtaler", "masternodecurrent", &masternodecurrent, true, true, false},
        {"rwtaler", "masternodedebug", &masternodedebug, true, true, false},
        {"rwtaler", "startmasternode", &startmasternode, true, true, false},
        {"rwtaler", "createmasternodekey", &createmasternodekey, true, true, false},
        {"rwtaler", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"rwtaler", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"rwtaler", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"rwtaler", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"rwtaler", "getmasternodescores", &getmasternodescores, true, true, false},
        {"rwtaler", "preparebudget", &preparebudget, true, true, false},
        {"rwtaler", "submitbudget", &submitbudget, true, true, false},
        {"rwtaler", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"rwtaler", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"rwtaler", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"rwtaler", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"rwtaler", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"rwtaler", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"rwtaler", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"rwtaler", "checkbudgets", &checkbudgets, true, true, false},
        {"rwtaler", "mnsync", &mnsync, true, true, false},
        {"rwtaler", "spork", &spork, true, true, false},
        {"rwtaler", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzrwtseed", &getzrwtseed, false, false, true},
        {"zerocoin", "setzrwtseed", &setzrwtseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzrwt", &searchdzrwt, false, false, true},
        {"zerocoin", "dzrwtstate", &dzrwtstate, false, false, true},
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:15161/\n";
}
