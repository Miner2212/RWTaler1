...
/** Utility functions used by the RWTaler Qt UI.
 */
namespace GUIUtil
{
...
// Render RWTaler addresses in monospace font
...
// Parse "rwtaler:" URI into recipient object, return true on successful parsing
