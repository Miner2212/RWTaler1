...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(RWT);
    unitlist.append(mRWT);
    unitlist.append(uRWT);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case RWT:
            return QString("tRWT");
        case mRWT:
            return QString("mtRWT");
        case uRWT:
            return QString::fromUtf8("μtRWT");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case RWT:
            return QString("RWT");
        case mRWT:
            return QString("Milli-RWT (1 / 1" THIN_SP_UTF8 "000)");
        case uRWT:
            return QString("Micro-RWT (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case RWT:
            return QString("TestRWTs");
        case mRWT:
            return QString("Milli-TestRWT (1 / 1" THIN_SP_UTF8 "000)");
        case uRWT:
            return QString("Micro-TestRWT (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
