                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzRWTPathCustom = GetArg("-zrwtbackuppath", "");
    ...
    if(!strzRWTPathCustom.empty()) {
        ui->wallet_customzrwtbackuppath->setText(QString::fromStdString(strzRWTPathCustom));
        ui->wallet_customzrwtbackuppath_label->setVisible(true);
        ui->wallet_customzrwtbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzRWTPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the RWTaler RPC console.") + "<br>" +
