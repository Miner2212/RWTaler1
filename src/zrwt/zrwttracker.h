...
#ifndef RWTaler_ZRWTTRACKER_H
#define RWTaler_ZRWTTRACKER_H
...
public:
    CzRWTTracker(std::string strWalletFile);
    ~CzRWTTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzRWTWallet* zRWTWallet = NULL);
