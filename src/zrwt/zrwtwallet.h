...
#ifndef RWTaler_ZRWTWALLET_H
#define RWTaler_ZRWTWALLET_H
...
public:
    CzRWTWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZRWT(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZRWT(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
