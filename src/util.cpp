...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL) {
        ...
        if (ptrCategory.get() == NULL) {
            ...
            // "rwtaler" is a composite category enabling all RWTaler-related debug output
...
// Windows < Vista: C:\Documents and Settings\Username\Application Data\RWTaler
// Windows >= Vista: C:\Users\Username\AppData\Roaming\RWTaler
// Mac: ~/Library/Application Support/RWTaler
// Unix: ~/.rwtaler
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "RWTaler";
#else
    fs::path pathRet;
