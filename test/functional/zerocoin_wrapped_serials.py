...
from fake_stake.base_test import RWTaler_FakeStakeTest

class zRWTwrappedSerialsTest(RWTaler_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zRWTs..." % DENOM_TO_USE)
